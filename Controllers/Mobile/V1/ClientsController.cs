...
namespace AonFreelancing.Controllers.Mobile.V1
{
    ...
    public class ClientsController : ControllerBase
    {
        ...
        public ClientsController(MyContext context, UserManager<User> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> GetAllClients()
        {
            ...
            clientDtoList = await _context.Users.OfType<Client>()
        ...
        public async Task<IActionResult> GetClientById(string id)
        {
            ...
            clientDto = await _context.Users.OfType<Client>()
                                    .Select(c => new ViewClientDto
                                    {
                                        Id = c.Id,
                                        Name = c.Name,
        ...
        public async Task<IActionResult> CreateClient([FromBody] AddClientDto clientDto)
        {
            ...
            await _userManager.CreateAsync(client, clientDto.Password);
        ...
        {
            Client client = await _context.Users.OfType<Client>().FirstOrDefaultAsync(f => f.Id == id);
            if (client != null)
            {
                // or use this Users.OfType<Client>()
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateClient([FromBody] UpdateClientDto clientDto, string id)
        {
            Client client = _context.Users.OfType<Client>().FirstOrDefault(f => f.Id == id);
            if (client != null)
            {
